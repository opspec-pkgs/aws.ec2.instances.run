[![build](https://github.com/opspec-pkgs/aws.ec2.instances.run/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/aws.ec2.instances.run/actions/workflows/build.yml)
